...
[![npm version](https://img.shields.io/npm/v/@pseinfo/database-schema)](https://npmjs.com/@pseinfo/database-schema)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue)](https://github.com/pseinfo/database-schema/blob/master/LICENSE)
[![Schema](https://img.shields.io/badge/Schema-JSON-blue)](https://unpkg.com/@pseinfo/database-schema/src/schema.json)
